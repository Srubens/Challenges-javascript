(function(){
    ...
    */
    var operation = {
        ...
        '-': function fewer(a,b){ return a - b },
        '*': function mutiplication(a,b){ return a * b },
    ...
    */
    function showOperationMessage(operator, numberA,numberB){
        return 'A operação ' + numberA + ' ' + operator + ' ' + numberB + ' =';
    }
    ...
    */
    ...
    var ivalido = calculator(operationSignal);
